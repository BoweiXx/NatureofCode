  ...
  return (function (t) {
    ...
    function (t, e, s) {
      ...
      const me = ((t) => (e, s, [n, i, o], r) => {
        ...
        ge = ((t) => (e, s, n, i) => t(e[i], (t) => t[0] === s && t[1] === n))(
          T
        ),
        ve = new WeakMap(),
        ye = ((t) => (e) => {
      ...
      const Ue = ((t) => (e) =>
          ...
          e instanceof t.AudioNode)(Te),
        Qe = ((t) => (e) =>
          null !== t &&
          "function" == typeof t.AudioParam &&
          e instanceof t.AudioParam)(Te),
      ...
      const cn = ((t, e, s, n, i, o, r) =>
        ...
        bn = ((t, e, s, n, i, o, r, a, c, h, u, l, p, d, f, _, m, g, v, y) =>
          class extends f {
            constructor(e, s) {
              super(e, s),
      ...
      const Rn = ((t) => (e, s, n = 0, i = 0) => {
        ...
        In = new WeakMap(),
        Vn = ((t, e) => (s) => e(t, s))(In, b),
        Nn = ((t, e, s, n, i, o, r, a, c, h, u, l, p) => (d, f, _, g) => {
        ...
        })(Rn, q, At, Es, Wt, Is, Qt, Yt, Ht, Fn, _n, Vn, As),
        Pn = ((t, e, s, n, i) => (o, r, a, c, h, u) => {
          if (null !== a)
            try {
              const e = new a(o, c, u),
                n = new Map();
        ...
        jn = ((t, e, s, n, i, o, r, a, c, h, u, l, p, d, f, _) => (m, g, v) => {
          const y = new WeakMap();
          let x = null;
          return {
            render(w, b, T) {
        ...
        })(as, Rn, cs, Es, Wt, Is, Qt, qn, Fn, _n, st, vn, Ve, us, Oe, Us),
        Ln = ((t) => (e) => t.get(e))(mn),
        zn = ((t) => (e, s) => {
          t.set(e, s);
        })(In),
        ...
        })(He, xe, Ae, Dn, Us, R, ts, es),
        Un =
          (((t, e, s, n, i) => {})(xe, At, Wn, $s, Gn),
          ((t, e, s, n, i) =>
            class extends t {
              constructor(t, s, i) {
                let o;
        ...
        Zn = ((Xn = h), (Yn = Ue), (t) => Xn.has(t) || Yn(t));
      var Xn, Yn;
      const Hn = (($n = l), (Jn = Qe), (t) => $n.has(t) || Jn(t));
      var $n, Jn;
      const Kn = ((t, e) => (s) => {
          const n = t.get(s);
          return e(n) || e(s);
      ...
      function mi(t) {
        return _i(t) && /^([a-g]{1}(?:b|#|x|bb)?)(-?[0-9]+)/i.test(t);
      }
      const gi = "object" == typeof self ? self : null,
        vi =
          gi &&
          (gi.hasOwnProperty("AudioContext") ||
            gi.hasOwnProperty("webkitAudioContext"));
      function yi(t, e, s, n) {
        var i,
          o = arguments.length,
          r =
        ...
        if (pi(t) && pi(s))
          for (const e in s)
            Ai(e, s[e])
              ? (t[e] = s[e])
              : pi(s[e])
              ? (t[e] || Object.assign(t, { [e]: {} }), Di(t[e], s[e]))
      ...
      function Oi(t, e, s = [], n) {
        const i = {},
          o = Array.from(e);
        if (pi(o[0]) && n && !Reflect.has(o[0], n)) {
          Object.keys(o[0]).some((e) => Reflect.has(t, e)) ||
            (Di(i, { [n]: o[0] }), s.splice(s.indexOf(n), 1), o.shift());
        }
        if (1 === o.length && pi(o[0])) Di(i, o[0]);
        else for (let t = 0; t < s.length; t++) hi(o[t]) && (i[s[t]] = o[t]);
        return Di(t, i);
      }
      function Mi(t, e) {
        return ci(t) ? e : t;
       ...
       */ class Ri {
        ...
        log(...t) {
          (this.debug || (gi && this.toString() === gi.TONE_DEBUG_CLASS)) &&
            ri(this, ...t);
        }
        dispose() {
      ...
      class Pi extends Ri {
        constructor() {
          ...
          const t = Oi(Pi.getDefaults(), arguments, ["memory"]);
        ...
        cancel(t) {
          if (this._timeline.length > 1) {
            ...
            if (e >= 0)
              if (Vi(this._timeline[e].time, t)) {
                for (let s = e; s >= 0 && Vi(this._timeline[s].time, t); s--)
                  e = s;
          ...
          for (; s < i; ) {
            ...
            if (Vi(o[e], t)) {
              for (let s = n; s < this._timeline.length; s++) {
                if (!Vi(this._timeline[s][e], t)) break;
                n = s;
              }
              return n;
            }
            if (Ii(o[e], t) && qi(r[e], t)) return n;
            qi(o[e], t) ? (i = n) : (s = n + 1);
          }
          return -1;
        }
        ...
        forEachAtTime(t, e) {
          const s = this._search(t);
          if (-1 !== s && Vi(this._timeline[s].time, t)) {
            let n = s;
            for (let e = s; e >= 0 && Vi(this._timeline[e].time, t); e--) n = e;
            this._iterate(
              (t) => {
                e(t);
              },
      ...
      class Wi extends Ri {
        ...
        static mixin(t) {
          ["on", "once", "off", "emit"].forEach((e) => {
            const s = Object.getOwnPropertyDescriptor(Wi.prototype, e);
      ...
      class Ui extends Gi {
        constructor() {
          super(),
            ...
            (this._timeouts = new Pi()),
            (this._timeoutIds = 0),
            (this._initialized = !1),
            (this.isOffline = !1),
            (this._workletModules = new Map());
          const t = Oi(Ui.getDefaults(), arguments, ["context"]);
          t.context
        ...
        initialize() {
          ...
          return (
            this._initialized ||
              ((t = this), ji.forEach((e) => e(t)), (this._initialized = !0)),
            this
          );
        }
        createAnalyser() {
        ...
        createMediaStreamSource(t) {
          ei(ki(this._context), "Not available if OfflineAudioContext");
        ...
        set draw(t) {
          ei(!this._initialized, "Draw cannot be set after initialization."),
            (this._draw = t);
        }
        get destination() {
...
***************************************************************************** */ this
        ...
        addAudioWorkletModule(t, e) {
          return xi(this, void 0, void 0, function* () {
            ei(
              hi(this.rawContext.audioWorklet),
        ...
        resume() {
          return ki(this._context) ? this._context.resume() : Promise.resolve();
        }
        close() {
          return xi(this, void 0, void 0, function* () {
            var t;
            ki(this._context) && (yield this._context.close()),
              this._initialized && ((t = this), zi.forEach((e) => e(t)));
          });
        }
        getConstant(t) {
      ...
      class Yi extends Ri {
        constructor() {
          super(), (this.name = "ToneAudioBuffer"), (this.onload = Xi);
          const t = Oi(Yi.getDefaults(), arguments, [
            "url",
            "onload",
            "onerror",
          ]);
          (this.reverse = t.reverse),
            ...
            (t.url && Ci(t.url)) || t.url instanceof Yi
              ? this.set(t.url)
              : _i(t.url) && this.load(t.url).catch(t.onerror);
        }
        static getDefaults() {
          return { onerror: Xi, onload: Xi, reverse: !1 };
        }
        get sampleRate() {
          return this._buffer ? this._buffer.sampleRate : Ki().sampleRate;
        }
        set(t) {
          return (
            t instanceof Yi
        ...
        load(t) {
          return xi(this, void 0, void 0, function* () {
            ...
            try {
              ...
              const t = Yi.downloads.indexOf(e);
              Yi.downloads.splice(t, 1);
            }
            return this;
          });
        }
        ...
        toMono(t) {
          if (li(t)) this.fromArray(this.toArray(t));
          else {
        ...
        toArray(t) {
          if (li(t)) return this.getChannelData(t);
        ...
        slice(t, e = this.duration) {
          ...
          ei(s < n, "The start time must be less than the end time");
          const i = n - s,
            o = Ki().createBuffer(this.numberOfChannels, i, this.sampleRate);
        ...
        static loaded() {
          return xi(this, void 0, void 0, function* () {
            for (yield Promise.resolve(); Yi.downloads.length; )
              yield Yi.downloads[0];
          });
        }
      }
      (Yi.baseUrl = ""), (Yi.downloads = []);
      class Hi extends Ui {
        constructor() {
          var t, e, s;
          super({
      ...
      let Ji = $i;
      function Ki() {
        return Ji === $i && vi && to(new Ui()), Ji;
      }
      function to(t) {
        Ji = ki(t) ? new Ui(t) : Si(t) ? new Hi(t) : t;
      }
      function eo() {
        return Ji.resume();
      }
      if (gi && !gi.TONE_SILENCE_LOGGING) {
        let t = "v";
        "dev" === o && (t = "");
        const e = ` * Tone.js ${t}${o} * `;
      ...
      let oo = 440;
      function ro(t) {
        return Math.round(ao(t));
      }
      function ao(t) {
        return 69 + 12 * Math.log2(t / oo);
      }
      function co(t) {
        return oo * Math.pow(2, (t - 69) / 12);
      }
      class ho extends Ri {
        constructor(t, e, s) {
          super(),
        ...
        valueOf() {
          if (
            (this._val instanceof ho && this.fromType(this._val), ci(this._val))
          )
            return this._noArg();
          if (_i(this._val) && ci(this._units)) {
            for (const t in this._expressions)
              if (this._expressions[t].regexp.test(this._val.trim())) {
                this._units = t;
                break;
              }
          } else if (pi(this._val)) {
            let t = 0;
          ...
          return _i(this._val) ? parseFloat(this._val) : this._val;
        }
        _frequencyToUnits(t) {
          return 1 / t;
        }
      ...
      class uo extends ho {
        ...
        _getExpressions() {
          return Object.assign(super._getExpressions(), {
            ...
            quantize: {
              method: (t) => {
                const e = new uo(this.context, t).valueOf();
        ...
        toNotation() {
          ...
          e.push("0");
          let s = e[0],
            n = new uo(this.context, e[0]).toSeconds();
          return (
            e.forEach((e) => {
              const i = new uo(this.context, e).toSeconds();
      ...
      class po extends uo {
        ...
        _getExpressions() {
          return Object.assign({}, super._getExpressions(), {
            midi: {
              regexp: /^(\d+(?:\.\d+)?midi)/,
              method(t) {
                return "midi" === this.defaultUnits ? t : po.mtof(t);
              },
            },
            note: {
              regexp: /^([a-g]{1}(?:b|#|x|bb)?)(-?[0-9]+)/i,
              method(t, e) {
                const s = fo[t.toLowerCase()] + 12 * (parseInt(e, 10) + 1);
                return "midi" === this.defaultUnits ? s : po.mtof(s);
              },
            },
            tr: {
              regexp: /^(\d+(?:\.\d+)?):(\d+(?:\.\d+)?):?(\d+(?:\.\d+)?)?/,
        ...
        transpose(t) {
          return new po(this.context, this.valueOf() * io(t));
        }
        harmonize(t) {
          return t.map((t) => this.transpose(t));
        }
        toMidi() {
          return ro(this.valueOf());
        }
        toNote() {
      ...
      const fo = {
        ...
        _o = ["C", "C#", "D", "D#", "E", "F", "F#", "G", "G#", "A", "A#", "B"];
      function mo(t, e) {
        return new po(Ki(), t, e);
      }
      class go extends uo {
        constructor() {
      ...
      function vo(t, e) {
        return new go(Ki(), t, e);
      }
      class yo extends Ri {
        constructor() {
          super();
          const t = Oi(yo.getDefaults(), arguments, ["context"]);
          this.defaultContext
        ...
        toSeconds(t) {
          return new uo(this.context, t).toSeconds();
        }
        toFrequency(t) {
          return new po(this.context, t).toFrequency();
        }
        toTicks(t) {
          return new go(this.context, t).toTicks();
        }
          ...
          return (
            Object.keys(t).forEach((e) => {
              if (Reflect.has(this, e)) {
                const s = this[e];
                hi(s) && hi(s.value) && hi(s.setValueAtTime)
                  ? (t[e] = s.value)
                  : s instanceof yo
        ...
        set(t) {
          return (
            Object.keys(t).forEach((e) => {
              Reflect.has(this, e) &&
                hi(this[e]) &&
                (this[e] && hi(this[e].value) && hi(this[e].setValueAtTime)
                  ? this[e].value !== t[e] && (this[e].value = t[e])
                  : this[e] instanceof yo
                  ? this[e].set(t[e])
                  : (this[e] = t[e]));
            }),
            this
      ...
      class wo extends yo {
        constructor() {
          super(Oi(wo.getDefaults(), arguments, ["param", "units", "convert"])),
            (this.name = "Param"),
            (this.overridden = !1),
            (this._minOutput = 1e-7);
          const t = Oi(wo.getDefaults(), arguments, [
            "param",
            "units",
            "convert",
          ]);
          for (
            ei(
              hi(t.param) && (bi(t.param) || t.param instanceof wo),
          ...
          (this._swappable = !!hi(t.swappable) && t.swappable),
            this._swappable
              ? ((this.input = this.context.createGain()),
                (this._param = t.param),
                this.input.connect(this._param))
              : (this._param = this.input = t.param),
            (this._events = new Pi(1e3)),
        ...
        static getDefaults() {
          return Object.assign(yo.getDefaults(), {
            convert: !0,
            units: "number",
          });
        }
        ...
        _toType(t) {
          return this.convert && "decibels" === this.units ? no(t) : t;
        }
        setValueAtTime(t, e) {
        ...
        exponentialRampToValueAtTime(t, e) {
          ...
          (s = Vi(s, 0) ? this._minOutput : s), this._assertRange(s);
      ...
      class bo extends yo {
        ...
        get numberOfInputs() {
          return hi(this.input)
            ? bi(this.input) || this.input instanceof wo
              ? 1
              : this.input.numberOfInputs
            : 0;
        }
        get numberOfOutputs() {
          return hi(this.output) ? this.output.numberOfOutputs : 0;
        }
        _isAudioNode(t) {
          return hi(t) && (t instanceof bo || Ti(t));
        }
        _getInternalNodes() {
        ...
        _getChannelProperties() {
          ...
          ei(t.length > 0, "ToneAudioNode does not have any internal nodes");
          const e = t[0];
          return {
        ...
        toMaster() {
          return (
            ai("toMaster() has been renamed toDestination()"),
            this.toDestination()
          );
        }
        disconnect(t, e = 0, s = 0) {
          return ko(this, t, e, s), this;
        }
        chain(...t) {
        ...
        dispose() {
          return (
            super.dispose(),
            hi(this.input) &&
              (this.input instanceof bo
                ? this.input.dispose()
                : Ti(this.input) && this.input.disconnect()),
            hi(this.output) &&
              (this.output instanceof bo
                ? this.output.dispose()
                : Ti(this.output) && this.output.disconnect()),
            (this._internalChannels = []),
            this
          );
        }
      ...
      function To(...t) {
        const e = t.shift();
        t.reduce(
          (t, e) => (t instanceof bo ? t.connect(e) : Ti(t) && So(t, e), e),
          e
        );
      }
      function So(t, e, s = 0, n = 0) {
        for (
          ei(hi(t), "Cannot connect from undefined node"),
            ei(hi(e), "Cannot connect to undefined node"),
            (e instanceof bo || Ti(e)) &&
              ei(e.numberOfInputs > 0, "Cannot connect to node with no inputs"),
            ei(
              t.numberOfOutputs > 0,
              "Cannot connect from node with no outputs"
            );
          e instanceof bo || e instanceof wo;

        )
          hi(e.input) && (e = e.input);
        for (; t instanceof bo; ) hi(t.output) && (t = t.output);
        bi(e) ? t.connect(e, s) : t.connect(e, s, n);
      }
      function ko(t, e, s = 0, n = 0) {
        if (hi(e)) for (; e instanceof bo; ) e = e.input;
        for (; !Ti(t); ) hi(t.output) && (t = t.output);
        bi(e)
          ? t.disconnect(e, s)
          : Ti(e)
          ? t.disconnect(e, s, n)
      ...
      class Co extends bo {
        constructor() {
          super(Oi(Co.getDefaults(), arguments, ["gain", "units"])),
            (this.name = "Gain"),
            (this._gainNode = this.context.createGain()),
            (this.input = this._gainNode),
            (this.output = this._gainNode);
          const t = Oi(Co.getDefaults(), arguments, ["gain", "units"]);
          (this.gain = new wo({
      ...
      class Ao extends bo {
        constructor(t) {
          super(t),
            ...
            (this._stopTime = -1),
            (this._timeout = -1),
            (this.output = new Co({ context: this.context, gain: 0 })),
        ...
        _startGain(t, e = 1) {
          ei(-1 === this._startTime, "Source cannot be started more than once");
        ...
        _stopGain(t) {
          ei(-1 !== this._startTime, "'start' must be called before 'stop'"),
            this.cancelStop();
        ...
        _onended() {
          if (
            this.onended !== Xi &&
            (this.onended(this), (this.onended = Xi), !this.context.isOffline)
          ) {
        ...
        cancelStop() {
          return (
            this.log("cancelStop"),
            ei(-1 !== this._startTime, "Source is not started"),
      ...
      class Do extends Ao {
        constructor() {
          super(Oi(Do.getDefaults(), arguments, ["offset"])),
            (this.name = "ToneConstantSource"),
            (this._source = this.context.createConstantSource());
          const t = Oi(Do.getDefaults(), arguments, ["offset"]);
          So(this._source, this._gainNode),
            (this.offset = new wo({
              context: this.context,
              convert: t.convert,
      ...
      class Oo extends bo {
        constructor() {
          super(Oi(Oo.getDefaults(), arguments, ["value", "units"])),
            (this.name = "Signal"),
            (this.override = !0);
          const t = Oi(Oo.getDefaults(), arguments, ["value", "units"]);
          (this.output = this._constantSource = new Do({
            context: this.context,
            convert: t.convert,
            offset: t.value,
            units: t.units,
      ...
      function Mo(t, e, s, n) {
        (e instanceof wo || bi(e) || (e instanceof Oo && e.override)) &&
          (e.cancelScheduledValues(0),
          e.setValueAtTime(0, 0),
          e instanceof Oo && (e.overridden = !0)),
          So(t, e, s, n);
      }
      class Eo extends wo {
        constructor() {
          super(Oi(Eo.getDefaults(), arguments, ["value"])),
            (this.name = "TickParam"),
            (this._events = new Pi(1 / 0)),
            (this._multiplier = 1);
          const t = Oi(Eo.getDefaults(), arguments, ["value"]);
      ...
      class Ro extends Oo {
        constructor() {
          super(Oi(Ro.getDefaults(), arguments, ["value"])),
            (this.name = "TickSignal");
          const t = Oi(Ro.getDefaults(), arguments, ["value"]);
          this.input = this._param = new Eo({
            context: this.context,
            convert: t.convert,
      ...
      class qo extends yo {
        constructor() {
          super(Oi(qo.getDefaults(), arguments, ["frequency"])),
            (this.name = "TickSource"),
            (this._state = new xo()),
            (this._tickOffset = new Pi());
          const t = Oi(qo.getDefaults(), arguments, ["frequency"]);
      ...
      class Fo extends yo {
        constructor() {
          super(Oi(Fo.getDefaults(), arguments, ["callback", "frequency"])),
            (this.name = "Clock"),
            (this.callback = Xi),
            (this._lastUpdate = 0),
            (this._state = new xo("stopped")),
            (this._boundLoop = this._loop.bind(this));
          const t = Oi(Fo.getDefaults(), arguments, ["callback", "frequency"]);
          (this.callback = t.callback),
            (this._tickSource = new qo({
              context: this.context,
      ...
      class Io extends bo {
        constructor() {
          super(Oi(Io.getDefaults(), arguments, ["delayTime", "maxDelay"])),
            (this.name = "Delay");
          const t = Oi(Io.getDefaults(), arguments, ["delayTime", "maxDelay"]),
        ...
        static getDefaults() {
          return Object.assign(bo.getDefaults(), { delayTime: 0, maxDelay: 1 });
        }
        get maxDelay() {
      ...
      function Vo(t, e, s = 2, n = Ki().sampleRate) {
        return xi(this, void 0, void 0, function* () {
          const i = Ki(),
            o = new Hi(s, e, n);
          to(o), yield t(o);
      ...
      class No extends Ri {
        ...
        static getDefaults() {
          return { baseUrl: "", onerror: Xi, onload: Xi, urls: {} };
        }
        has(t) {
        ...
        get(t) {
          return (
            ei(this.has(t), "ToneAudioBuffers has no buffer named: " + t),
        ...
        add(t, e, s = Xi, n = Xi) {
          return (
            _i(e)
              ? this._buffers.set(t.toString(), new Yi(this.baseUrl + e, s, n))
              : this._buffers.set(t.toString(), new Yi(e, s, n)),
            this
          );
        }
        dispose() {
      ...
      class Po extends po {
        ...
        _frequencyToUnits(t) {
          return ro(super._frequencyToUnits(t));
        }
        _ticksToUnits(t) {
          return ro(super._ticksToUnits(t));
        }
        _beatsToUnits(t) {
          return ro(super._beatsToUnits(t));
        }
        _secondsToUnits(t) {
          return ro(super._secondsToUnits(t));
        }
        toMidi() {
          return this.valueOf();
        }
        toFrequency() {
          return co(this.toMidi());
        }
        transpose(t) {
          return new Po(this.context, this.toMidi() + t);
        }
      }
      function jo(t, e) {
        return new Po(Ki(), t, e);
      ...
      class Wo extends Ri {
        ...
        add(t) {
          ei(hi(t.time), "Events must have a time property"),
            ei(hi(t.duration), "Events must have a duration parameter"),
            (t.time = t.time.valueOf());
          let e = new Go(t.time, t.time + t.duration, t);
          for (
      ...
      class Uo extends bo {
        constructor() {
          super(Oi(Uo.getDefaults(), arguments, ["volume"])),
            (this.name = "Volume");
          const t = Oi(Uo.getDefaults(), arguments, ["volume"]);
          (this.input = this.output = new Co({
            context: this.context,
            gain: t.volume,
            units: "decibels",
          })),
        ...
        static getDefaults() {
          return Object.assign(bo.getDefaults(), { mute: !1, volume: 0 });
        }
        get mute() {
      ...
      class Qo extends bo {
        constructor() {
          super(Oi(Qo.getDefaults(), arguments)),
            (this.name = "Destination"),
            (this.input = new Uo({ context: this.context })),
            (this.output = new Co({ context: this.context })),
            (this.volume = this.input.volume);
          const t = Oi(Qo.getDefaults(), arguments);
          To(this.input, this.output, this.context.rawContext.destination),
            (this.mute = t.mute),
            (this._internalChannels = [
              this.input,
      ...
      Li((t) => {
        t.destination = new Qo({ context: t });
      }),
        Bi((t) => {
      ...
      class Zo extends Ri {
        constructor(t) {
          super(),
            ...
            (this._timeline = new Pi({ memory: 10 })),
      ...
      class Xo {
        constructor(t, e) {
          (this.id = Xo._eventId++), (this._remainderTime = 0);
        ...
        static getDefaults() {
          return { callback: Xi, once: !1, time: 0 };
        }
        get floatTime() {
      ...
      class Yo extends Xo {
        constructor(t, e) {
          ...
          const s = Object.assign(Yo.getDefaults(), e);
        ...
        _createEvent() {
          return Ii(this._nextTick, this.floatTime + this.duration)
            ? this.transport.scheduleOnce(
                this.invoke.bind(this),
                new Lo(this.context, this._nextTick).toSeconds()
              )
            : -1;
        }
        _createEvents(t) {
          Ii(this._nextTick + this._interval, this.floatTime + this.duration) &&
      ...
      class Ho extends yo {
        constructor() {
          super(Oi(Ho.getDefaults(), arguments)),
            (this.name = "Transport"),
            (this._loop = new Zo(!1)),
            (this._loopStart = 0),
            (this._loopEnd = 0),
            (this._scheduledEvents = {}),
            (this._timeline = new Pi()),
            (this._repeatedEvents = new Wo()),
            (this._syncedSignals = []),
            (this._swingAmount = 0);
          const t = Oi(Ho.getDefaults(), arguments);
          (this._ppq = t.ppq),
            (this._clock = new Fo({
        ...
        _processTick(t, e) {
          if (
            ...
            t +=
              new Lo(this.context, (2 * this._swingTicks) / 3).toSeconds() * n;
          }
        ...
        schedule(t, e) {
          const s = new Xo(this, {
            callback: t,
            time: new go(this.context, e).toTicks(),
          });
        ...
        scheduleRepeat(t, e, s, n = 1 / 0) {
          const i = new Yo(this, {
            callback: t,
            duration: new uo(this.context, n).toTicks(),
            interval: new uo(this.context, e).toTicks(),
            time: new go(this.context, s).toTicks(),
          });
        ...
        _bindClockEvents() {
          this._clock.on("start", (t, e) => {
            (e = new Lo(this.context, e).toSeconds()), this.emit("start", t, e);
          }),
        ...
        start(t, e) {
          let s;
          return hi(e) && (s = this.toTicks(e)), this._clock.start(t, s), this;
        }
        stop(t) {
        ...
        set timeSignature(t) {
          fi(t) && (t = (t[0] / t[1]) * 4), (this._timeSignature = t);
        }
        get loopStart() {
          return new uo(this.context, this._loopStart, "i").toSeconds();
        }
        set loopStart(t) {
          this._loopStart = this.toTicks(t);
        }
        get loopEnd() {
          return new uo(this.context, this._loopEnd, "i").toSeconds();
        }
        set loopEnd(t) {
        ...
        get swingSubdivision() {
          return new Lo(this.context, this._swingTicks).toNotation();
        }
        ...
        get position() {
          ...
          return new Lo(this.context, e).toBarsBeatsSixteenths();
        }
        set position(t) {
          const e = this.toTicks(t);
          this.ticks = e;
      ...
      class $o extends bo {
        constructor(t) {
          super(t),
            ...
            (this._synced = !1),
            (this._scheduled = []),
            (this._syncedStart = Xi),
            (this._syncedStop = Xi),
            (this._state.memory = 100),
            (this._state.increasing = !0),
            (this._volume = this.output = new Uo({
              context: this.context,
              mute: t.mute,
              volume: t.volume,
            })),
        ...
        start(t, e, s) {
          ...
          if (
            ...
            if (
              ...
              t &&
                ((t.offset = this.toSeconds(Mi(e, 0))),
            ...
            } else ni(this.context), this._start(n, e, s);
          else
            ei(
              qi(n, this._state.get(n).time),
        ...
        stop(t) {
          ...
          if (
            ...
            "started" === this._state.getValueAtTime(e) ||
              hi(this._state.getNextState("started", e)))
          ) {
      ...
      class Jo extends Ao {
        constructor() {
          super(Oi(Jo.getDefaults(), arguments, ["url", "onload"])),
            (this.name = "ToneBufferSource"),
            (this._source = this.context.createBufferSource()),
            (this._internalChannels = [this._source]),
            (this._sourceStarted = !1),
            (this._sourceStopped = !1);
          const t = Oi(Jo.getDefaults(), arguments, ["url", "onload"]);
          So(this._source, this._gainNode),
            (this._source.onended = () => this._stopSource()),
            (this.playbackRate = new wo({
              context: this.context,
            ...
            (this._buffer = new Yi(t.url, t.onload, t.onerror)),
        ...
        start(t, e, s, n = 1) {
          ei(this.buffer.loaded, "buffer is either not set or not loaded");
          const i = this.toSeconds(t);
          this._startGain(i, n),
            (e = this.loop ? Mi(e, this.loopStart) : Mi(e, 0));
      ...
      class Ko extends $o {
        constructor() {
          super(Oi(Ko.getDefaults(), arguments, ["type"])),
            (this.name = "Noise"),
            (this._source = null);
          const t = Oi(Ko.getDefaults(), arguments, ["type"]);
        ...
        set type(t) {
          if (
            (ei(t in er, "Noise: invalid type: " + t),
      ...
      const tr = { brown: null, pink: null, white: null },
        er = {
          get brown() {
            if (!tr.brown) {
              const t = [];
      ...
      class sr extends bo {
        constructor() {
          super(Oi(sr.getDefaults(), arguments, ["volume"])),
            (this.name = "UserMedia");
          const t = Oi(sr.getDefaults(), arguments, ["volume"]);
          (this._volume = this.output = new Uo({
            context: this.context,
            volume: t.volume,
          })),
        ...
        open(t) {
          return xi(this, void 0, void 0, function* () {
            ei(sr.supported, "UserMedia is not supported"),
              "started" === this.state && this.close();
            const e = yield sr.enumerateDevices();
            li(t)
              ? (this._device = e[t])
              : ((this._device = e.find(
                ...
                ei(hi(this._device), "No matching device " + t));
            const s = {
              audio: {
                echoCancellation: !1,
            ...
            if (!this._stream) {
              ...
              So(t, this.output), (this._mediaStream = t);
            }
            return this;
          });
        }
        ...
        static get supported() {
          return (
            ...
            hi(navigator.mediaDevices.getUserMedia)
          );
        }
      }
      function nr(t, e) {
        return xi(this, void 0, void 0, function* () {
          const s = e / t.context.sampleRate,
            n = new Hi(1, s, t.context.sampleRate);
          new t.constructor(
      ...
      class ir extends Ao {
        constructor() {
          super(Oi(ir.getDefaults(), arguments, ["frequency", "type"])),
            (this.name = "ToneOscillatorNode"),
            (this._oscillator = this.context.createOscillator()),
            (this._internalChannels = [this._oscillator]);
          const t = Oi(ir.getDefaults(), arguments, ["frequency", "type"]);
          So(this._oscillator, this._gainNode),
            (this.type = t.type),
      ...
      class or extends $o {
        constructor() {
          super(Oi(or.getDefaults(), arguments, ["frequency", "type"])),
            (this.name = "Oscillator"),
            (this._oscillator = null);
          const t = Oi(or.getDefaults(), arguments, ["frequency", "type"]);
          (this.frequency = new Oo({
            context: this.context,
            units: "frequency",
            value: t.frequency,
          })),
        ...
        _getCachedPeriodicWave() {
          if ("custom" === this._type) {
            return or._periodicWaveCache.find((t) => {
              return (
                t.phase === this._phase &&
                ((e = t.partials),
                (s = this._partials),
          ...
          if (0 === this._phase && e)
            ...
            if (hi(e)) {
              ...
              (this._wave = n),
                ...
                or._periodicWaveCache.length > 100 &&
                  or._periodicWaveCache.shift();
            }
          }
        }
        get baseType() {
        ...
        getInitialValue() {
          ...
          return Ni(-this._inverseFFT(t, e, this._phase) / s, -1, 1);
        }
        get partials() {
      ...
      class rr extends bo {
        constructor() {
          super(Object.assign(Oi(rr.getDefaults(), arguments, ["context"])));
        }
        connect(t, e = 0, s = 0) {
          return Mo(this, t, e, s), this;
        }
      ...
      class ar extends rr {
        constructor() {
          super(
            Object.assign(
              Oi(ar.getDefaults(), arguments, ["mapping", "length"])
            )
          ),
          ...
          const t = Oi(ar.getDefaults(), arguments, ["mapping", "length"]);
          fi(t.mapping) || t.mapping instanceof Float32Array
            ? (this.curve = Float32Array.from(t.mapping))
            : ui(t.mapping) && this.setMap(t.mapping, t.length);
        }
        static getDefaults() {
          return Object.assign(Oo.getDefaults(), { length: 1024 });
        }
        setMap(t, e = 1024) {
      ...
      class hr extends Oo {
        constructor() {
          super(Object.assign(Oi(hr.getDefaults(), arguments, ["value"]))),
            (this.name = "Multiply"),
            (this.override = !1);
          const t = Oi(hr.getDefaults(), arguments, ["value"]);
          (this._mult = this.input = this.output = new Co({
            context: this.context,
            minValue: t.minValue,
            maxValue: t.maxValue,
          })),
        ...
        static getDefaults() {
          return Object.assign(Oo.getDefaults(), { value: 0 });
        }
        dispose() {
      ...
      class ur extends $o {
        constructor() {
          super(
            ...
            (this._modulationScale = new cr({ context: this.context })),
            (this._modulationNode = new Co({ context: this.context }));
          const t = Oi(ur.getDefaults(), arguments, [
            "frequency",
            "type",
            "modulationType",
          ]);
          (this._carrier = new or({
            ...
            Qi(this, ["frequency", "detune", "harmonicity"]);
        }
        static getDefaults() {
      ...
      class lr extends $o {
        constructor() {
          super(
            ...
            (this._modulationNode = new Co({ context: this.context, gain: 0 }));
          const t = Oi(lr.getDefaults(), arguments, [
            "frequency",
            "type",
            "modulationType",
          ]);
          (this._carrier = new or({
            ...
            Qi(this, ["modulationIndex", "frequency", "detune", "harmonicity"]);
        }
        static getDefaults() {
          return Object.assign(or.getDefaults(), {
            harmonicity: 1,
      ...
      class pr extends $o {
        constructor() {
          super(Oi(pr.getDefaults(), arguments, ["frequency", "width"])),
            (this.name = "PulseOscillator"),
            (this._widthGate = new Co({ context: this.context, gain: 0 })),
            (this._thresh = new ar({
              context: this.context,
              mapping: (t) => (t <= 0 ? -1 : 1),
            }));
          const t = Oi(pr.getDefaults(), arguments, ["frequency", "width"]);
          (this.width = new Oo({
            context: this.context,
            units: "audioRange",
            value: t.width,
            ...
            Qi(this, ["width", "frequency", "detune"]);
        }
        static getDefaults() {
          return Object.assign($o.getDefaults(), {
            detune: 0,
      ...
      class dr extends $o {
        constructor() {
          super(
            Oi(dr.getDefaults(), arguments, ["frequency", "type", "spread"])
          ),
            (this.name = "FatOscillator"),
            (this._oscillators = []);
          const t = Oi(dr.getDefaults(), arguments, [
            "frequency",
            "type",
            "spread",
          ]);
        ...
        set count(t) {
          if ((si(t, 1), this._oscillators.length !== t)) {
            ...
            for (let e = 0; e < t; e++) {
              const s = new or({
                ...
                partialCount: this._partialCount,
                onstop: 0 === e ? () => this.onstop(this) : Xi,
              });
      ...
      class fr extends $o {
        constructor() {
          super(
            ...
            (this.sourceType = "pwm"),
            (this._scale = new hr({ context: this.context, value: 2 }));
          const t = Oi(fr.getDefaults(), arguments, [
            "frequency",
            "modulationFrequency",
          ]);
          (this._pulse = new pr({
            ...
            Qi(this, ["modulationFrequency", "frequency", "detune"]);
        }
        static getDefaults() {
          return Object.assign($o.getDefaults(), {
            detune: 0,
      ...
      class mr extends $o {
        constructor() {
          super(Oi(mr.getDefaults(), arguments, ["frequency", "type"])),
            (this.name = "OmniOscillator");
          const t = Oi(mr.getDefaults(), arguments, ["frequency", "type"]);
          (this.frequency = new Oo({
            context: this.context,
            units: "frequency",
            value: t.frequency,
      ...
      class gr extends Oo {
        constructor() {
          super(Object.assign(Oi(gr.getDefaults(), arguments, ["value"]))),
            (this.override = !1),
            (this.name = "Add"),
            (this._sum = new Co({ context: this.context })),
            (this.input = this._sum),
            (this.output = this._sum),
            (this.addend = this._param),
            To(this._constantSource, this._sum);
        }
        static getDefaults() {
          return Object.assign(Oo.getDefaults(), { value: 0 });
        }
      ...
      class vr extends rr {
        constructor() {
          super(Object.assign(Oi(vr.getDefaults(), arguments, ["min", "max"]))),
            (this.name = "Scale");
          const t = Oi(vr.getDefaults(), arguments, ["min", "max"]);
          (this._mult = this.input = new hr({
            context: this.context,
            value: t.max - t.min,
          })),
            (this._add = this.output = new gr({
              context: this.context,
              value: t.min,
            })),
            (this._min = t.min),
        ...
        static getDefaults() {
          return Object.assign(rr.getDefaults(), { max: 1, min: 0 });
        }
        get min() {
          return this._min;
        }
      ...
      class yr extends rr {
        constructor() {
          super(Object.assign(Oi(yr.getDefaults(), arguments))),
            (this.name = "Zero"),
            (this._gain = new Co({ context: this.context })),
        ...
        dispose() {
          return (
            super.dispose(), ko(this.context.getConstant(0), this._gain), this
          );
        }
      }
      class xr extends bo {
        constructor() {
          super(Oi(xr.getDefaults(), arguments, ["frequency", "min", "max"])),
            (this.name = "LFO"),
            (this._stoppedValue = 0),
            (this._units = "number"),
            (this.convert = !0),
            (this._fromType = wo.prototype._fromType),
            (this._toType = wo.prototype._toType),
            (this._is = wo.prototype._is),
            (this._clampValue = wo.prototype._clampValue);
          const t = Oi(xr.getDefaults(), arguments, [
            "frequency",
            "min",
            "max",
          ]);
          (this._oscillator = new or(t)),
            (this.frequency = this._oscillator.frequency),
            (this._amplitudeGain = new Co({
              context: this.context,
              gain: t.amplitude,
              units: "normalRange",
            })),
            (this.amplitude = this._amplitudeGain.gain),
            (this._stoppedSignal = new Oo({
              context: this.context,
              units: "audioRange",
              value: 0,
            })),
            (this._zeros = new yr({ context: this.context })),
            (this._a2g = new cr({ context: this.context })),
            (this._scaler = this.output = new vr({
              context: this.context,
              max: t.max,
              min: t.min,
            })),
        ...
        connect(t, e, s) {
          return (
            (t instanceof wo || t instanceof Oo) &&
      ...
      function br(t, e = 1 / 0) {
        ...
        return function (n, i) {
          Reflect.defineProperty(n, i, {
            ...
            set: function (n) {
              si(this.toSeconds(n), t, e), s.set(this, n);
            },
          });
        };
      }
      class Tr extends $o {
        constructor() {
          super(Oi(Tr.getDefaults(), arguments, ["url", "onload"])),
            (this.name = "Player"),
            (this._activeSources = new Set());
          const t = Oi(Tr.getDefaults(), arguments, ["url", "onload"]);
          (this._buffer = new Yi({
        ...
        _start(t, e, s) {
          e = this._loop ? Mi(e, this._loopStart) : Mi(e, 0);
          const n = this.toSeconds(e),
            i = s;
          s = Mi(s, Math.max(this._buffer.duration - n, 0));
        ...
        set loopStart(t) {
          (this._loopStart = t),
            this.buffer.loaded &&
              si(this.toSeconds(t), 0, this.buffer.duration),
      ...
      yi([br(0)], Tr.prototype, "fadeIn", void 0),
        yi([br(0)], Tr.prototype, "fadeOut", void 0);
      class Sr extends bo {
        constructor() {
          super(Oi(Sr.getDefaults(), arguments, ["urls", "onload"], "urls")),
            (this.name = "Players"),
            (this.input = void 0),
            (this._players = new Map());
          const t = Oi(Sr.getDefaults(), arguments, ["urls", "onload"], "urls");
          (this._volume = this.output = new Uo({
            context: this.context,
            volume: t.volume,
          })),
      ...
      class kr extends $o {
        constructor() {
          super(Oi(kr.getDefaults(), arguments, ["url", "onload"])),
            (this.name = "GrainPlayer"),
            (this._loopStart = 0),
            (this._loopEnd = 0),
            (this._activeSources = []);
          const t = Oi(kr.getDefaults(), arguments, ["url", "onload"]);
          (this.buffer = new Yi({
            onload: t.onload,
            onerror: t.onerror,
            reverse: t.reverse,
        ...
        _start(t, e, s) {
          (e = Mi(e, 0)), (e = this.toSeconds(e)), (t = this.toSeconds(t));
        ...
        _tick(t) {
          ...
          const n = s < this._overlap ? 0 : this._overlap,
            i = new Jo({
              ...
              loopStart: this._loopStart,
              loopEnd: this._loopEnd,
              playbackRate: io(this.detune / 100),
            }).connect(this.output);
        ...
        set loopStart(t) {
          this.buffer.loaded && si(this.toSeconds(t), 0, this.buffer.duration),
      ...
      class Dr extends rr {
        constructor() {
          super(...arguments),
            (this.name = "Negate"),
            (this._multiply = new hr({ context: this.context, value: -1 })),
      ...
      class Or extends Oo {
        constructor() {
          super(Object.assign(Oi(Or.getDefaults(), arguments, ["value"]))),
            (this.override = !1),
            (this.name = "Subtract"),
            (this._sum = new Co({ context: this.context })),
            (this.input = this._sum),
            (this.output = this._sum),
            (this._neg = new Dr({ context: this.context })),
            (this.subtrahend = this._param),
            To(this._constantSource, this._neg, this._sum);
        }
        static getDefaults() {
          return Object.assign(Oo.getDefaults(), { value: 0 });
        }
      ...
      class Mr extends rr {
        constructor() {
          super(Object.assign(Oi(Mr.getDefaults(), arguments))),
            (this.name = "GreaterThanZero"),
            (this._thresh = this.output = new ar({
              context: this.context,
              length: 127,
              mapping: (t) => (t <= 0 ? 0 : 1),
            })),
            (this._scale = this.input = new hr({
              context: this.context,
              value: 1e4,
            })),
      ...
      class Er extends Oo {
        constructor() {
          super(Object.assign(Oi(Er.getDefaults(), arguments, ["value"]))),
            (this.name = "GreaterThan"),
            (this.override = !1);
          const t = Oi(Er.getDefaults(), arguments, ["value"]);
          (this._subtract = this.input = new Or({
            context: this.context,
            value: t.value,
          })),
      ...
      class Rr extends rr {
        constructor() {
          super(Object.assign(Oi(Rr.getDefaults(), arguments, ["value"]))),
            (this.name = "Pow");
          const t = Oi(Rr.getDefaults(), arguments, ["value"]);
          (this._exponentScaler = this.input = this.output = new ar({
            context: this.context,
        ...
        static getDefaults() {
          return Object.assign(rr.getDefaults(), { value: 1 });
        }
        _expFunc(t) {
      ...
      class qr extends vr {
        constructor() {
          super(
            Object.assign(
              Oi(qr.getDefaults(), arguments, ["min", "max", "exponent"])
            )
          ),
            (this.name = "ScaleExp");
          const t = Oi(qr.getDefaults(), arguments, ["min", "max", "exponent"]);
          (this.input = this._exp = new Rr({
            context: this.context,
            value: t.exponent,
          })),
        ...
        static getDefaults() {
          return Object.assign(vr.getDefaults(), { exponent: 1 });
        }
        get exponent() {
      ...
      class Fr extends Oo {
        constructor() {
          ...
          (this._lastVal = t.value),
            ...
            (this._constantSource = this.output = new Do({
              context: this.context,
              offset: t.value,
              units: t.units,
            }).start(0)),
        ...
        getValueAtTime(t) {
          const e = new go(this.context, t).toSeconds();
          return super.getValueAtTime(e);
        }
        setValueAtTime(t, e) {
          const s = new go(this.context, e).toSeconds();
        ...
        setTargetAtTime(t, e, s) {
          const n = new go(this.context, e).toSeconds();
        ...
        setValueCurveAtTime(t, e, s, n) {
          const i = new go(this.context, e).toSeconds();
          return (
        ...
        exponentialRampTo(t, e, s) {
          const n = new go(this.context, s).toSeconds();
      ...
      class Ir extends bo {
        constructor() {
          super(
            ...
            (this.name = "Envelope"),
            (this._sig = new Oo({ context: this.context, value: 0 })),
            (this.output = this._sig),
            (this.input = void 0);
          const t = Oi(Ir.getDefaults(), arguments, [
            "attack",
            "decay",
            "sustain",
            "release",
        ...
        _getCurve(t, e) {
          ...
          {
            let s;
            for (s in Vr) if (Vr[s][e] === t) return s;
            return t;
          }
        }
        _setCurve(t, e, s) {
          if (_i(s) && Reflect.has(Vr, s)) {
            const n = Vr[s];
            pi(n) ? "_decayCurve" !== t && (this[t] = n[e]) : (this[t] = n);
          } else {
            if (!fi(s) || "_decayCurve" === t)
        ...
        asArray(t = 1024) {
          return xi(this, void 0, void 0, function* () {
            const e = t / this.context.sampleRate,
              s = new Hi(1, e, this.context.sampleRate),
      ...
      yi([br(0)], Ir.prototype, "attack", void 0),
        yi([br(0)], Ir.prototype, "decay", void 0),
        yi([wr(0, 1)], Ir.prototype, "sustain", void 0),
        yi([br(0)], Ir.prototype, "release", void 0);
      const Vr = (() => {
        let t, e;
        const s = [];
      ...
      class Nr extends bo {
        constructor() {
          super(Oi(Nr.getDefaults(), arguments)),
            (this._scheduledEvents = []),
            (this._synced = !1),
            (this._original_triggerAttack = this.triggerAttack),
            (this._original_triggerRelease = this.triggerRelease);
          const t = Oi(Nr.getDefaults(), arguments);
          (this._volume = this.output = new Uo({
            context: this.context,
            volume: t.volume,
          })),
        ...
        static getDefaults() {
          return Object.assign(bo.getDefaults(), { volume: 0 });
        }
        sync() {
          return (
            this._syncState() &&
      ...
      class Pr extends Nr {
        constructor() {
          super(Oi(Pr.getDefaults(), arguments));
          const t = Oi(Pr.getDefaults(), arguments);
        ...
        setNote(t, e) {
          const s = this.toSeconds(e),
            n = t instanceof po ? t.toFrequency() : t;
      ...
      yi([br(0)], Pr.prototype, "portamento", void 0);
      class jr extends Ir {
        constructor() {
          super(
            Oi(jr.getDefaults(), arguments, [
              "attack",
              "decay",
              "sustain",
              "release",
            ...
            (this._gainNode = new Co({ context: this.context, gain: 0 })),
            (this.output = this._gainNode),
            (this.input = this._gainNode),
      ...
      class Lr extends Pr {
        constructor() {
          super(Oi(Lr.getDefaults(), arguments)), (this.name = "Synth");
          const t = Oi(Lr.getDefaults(), arguments);
          (this.oscillator = new mr(
            Object.assign(
              {
                context: this.context,
                detune: t.detune,
            ...
            (this.envelope = new jr(
              Object.assign({ context: this.context }, t.envelope)
            )),
            this.oscillator.chain(this.envelope, this.output),
            Qi(this, ["oscillator", "frequency", "detune", "envelope"]);
        }
        static getDefaults() {
          return Object.assign(Pr.getDefaults(), {
            envelope: Object.assign(
              Ei(Ir.getDefaults(), Object.keys(bo.getDefaults())),
      ...
      class zr extends Pr {
        constructor() {
          super(Oi(zr.getDefaults(), arguments)),
            (this.name = "ModulationSynth");
          const t = Oi(zr.getDefaults(), arguments);
          (this._carrier = new Lr({
            context: this.context,
      ...
      class Br extends zr {
        constructor() {
          super(Oi(Br.getDefaults(), arguments)),
            (this.name = "AMSynth"),
            (this._modulationScale = new cr({ context: this.context })),
            this.frequency.connect(this._carrier.frequency),
            this.frequency.chain(this.harmonicity, this._modulator.frequency),
      ...
      class Wr extends bo {
        constructor() {
          super(Oi(Wr.getDefaults(), arguments, ["frequency", "type"])),
            (this.name = "BiquadFilter");
          const t = Oi(Wr.getDefaults(), arguments, ["frequency", "type"]);
      ...
      class Gr extends bo {
        constructor() {
          super(
            Oi(Gr.getDefaults(), arguments, ["frequency", "type", "rolloff"])
          ),
            (this.name = "Filter"),
            (this.input = new Co({ context: this.context })),
            (this.output = new Co({ context: this.context })),
            (this._filters = []);
          const t = Oi(Gr.getDefaults(), arguments, [
            "frequency",
            "type",
            "rolloff",
          ]);
        ...
        set rolloff(t) {
          const e = li(t) ? t : parseInt(t, 10),
            s = [-12, -24, -48, -96];
          let n = s.indexOf(e);
          ei(-1 !== n, "rolloff can only be " + s.join(", ")),
            (n += 1),
            (this._rolloff = e),
            this.input.disconnect(),
          ...
          for (let t = 0; t < n; t++) {
            const e = new Wr({ context: this.context });
            (e.type = this._type),
          ...
          (this._internalChannels = this._filters),
            To(this.input, ...this._internalChannels, this.output);
        }
        getFrequencyResponse(t = 128) {
          const e = new Wr({
        ...
        dispose() {
          return (
            ...
            Zi(this, ["detune", "frequency", "gain", "Q"]),
            this.frequency.dispose(),
            this.Q.dispose(),
            this.detune.dispose(),
            this.gain.dispose(),
      ...
      class Ur extends Ir {
        constructor() {
          ...
          (this._octaves = t.octaves),
            ...
            (this._exponent = this.input = new Rr({
              context: this.context,
              value: t.exponent,
            })),
            (this._scale = this.output = new vr({
              context: this.context,
      ...
      class Qr extends Pr {
        constructor() {
          super(Oi(Qr.getDefaults(), arguments)), (this.name = "MonoSynth");
          const t = Oi(Qr.getDefaults(), arguments);
          (this.oscillator = new mr(
        ...
        static getDefaults() {
          return Object.assign(Pr.getDefaults(), {
            ...
            filter: Object.assign(
              Ei(Gr.getDefaults(), Object.keys(bo.getDefaults())),
              { Q: 1, rolloff: -12, type: "lowpass" }
            ),
            filterEnvelope: Object.assign(
              Ei(Ur.getDefaults(), Object.keys(bo.getDefaults())),
              {
                attack: 0.6,
                baseFrequency: 200,
                decay: 0.2,
            ...
            oscillator: Object.assign(
              Ei(mr.getDefaults(), Object.keys($o.getDefaults())),
              { type: "sawtooth" }
            ),
          });
        }
      ...
      class Zr extends Pr {
        constructor() {
          super(Oi(Zr.getDefaults(), arguments)), (this.name = "DuoSynth");
          const t = Oi(Zr.getDefaults(), arguments);
          (this.voice0 = new Qr(
        ...
        static getDefaults() {
          return Di(Pr.getDefaults(), {
            vibratoAmount: 0.5,
            vibratoRate: 5,
            harmonicity: 1.5,
            voice0: Di(Ei(Qr.getDefaults(), Object.keys(Pr.getDefaults())), {
              filterEnvelope: {
                attack: 0.01,
                decay: 0,
                sustain: 1,
            ...
            voice1: Di(Ei(Qr.getDefaults(), Object.keys(Pr.getDefaults())), {
              filterEnvelope: {
                attack: 0.01,
                decay: 0,
                sustain: 1,
      ...
      class Xr extends zr {
        constructor() {
          super(Oi(Xr.getDefaults(), arguments)), (this.name = "FMSynth");
          const t = Oi(Xr.getDefaults(), arguments);
          (this.modulationIndex = new hr({
            context: this.context,
            value: t.modulationIndex,
        ...
        static getDefaults() {
          return Object.assign(zr.getDefaults(), { modulationIndex: 10 });
        }
        dispose() {
          return super.dispose(), this.modulationIndex.dispose(), this;
        }
      }
      const Yr = [1, 1.483, 1.932, 2.546, 2.63, 3.897];
      class Hr extends Pr {
        constructor() {
          super(Oi(Hr.getDefaults(), arguments)),
            (this.name = "MetalSynth"),
            (this._oscillators = []),
            (this._freqMultipliers = []);
          const t = Oi(Hr.getDefaults(), arguments);
          (this.detune = new Oo({
            context: this.context,
            units: "cents",
            value: t.detune,
            ...
            (this._amplitude = new Co({
              context: this.context,
              gain: 0,
            }).connect(this.output)),
            (this._highpass = new Gr({
              Q: 0,
              context: this.context,
              type: "highpass",
      ...
      class $r extends Lr {
        constructor() {
          super(Oi($r.getDefaults(), arguments)),
            (this.name = "MembraneSynth"),
            (this.portamento = 0);
          const t = Oi($r.getDefaults(), arguments);
          (this.pitchDecay = t.pitchDecay),
            (this.octaves = t.octaves),
            Qi(this, ["oscillator", "envelope"]);
        }
        static getDefaults() {
        ...
        setNote(t, e) {
          const s = this.toSeconds(e),
            n = this.toFrequency(t instanceof po ? t.toFrequency() : t),
            i = n * this.octaves;
          return (
      ...
      yi([wr(0)], $r.prototype, "octaves", void 0),
        yi([br(0)], $r.prototype, "pitchDecay", void 0);
      class Jr extends Nr {
        constructor() {
          super(Oi(Jr.getDefaults(), arguments)), (this.name = "NoiseSynth");
          const t = Oi(Jr.getDefaults(), arguments);
          (this.noise = new Ko(
        ...
        static getDefaults() {
          return Object.assign(Nr.getDefaults(), {
            ...
            noise: Object.assign(
              Ei(Ko.getDefaults(), Object.keys($o.getDefaults())),
              { type: "white" }
            ),
          });
        }
      ...
      class sa extends bo {
        constructor(t) {
          super(t),
            ...
            (this.workletOptions = {}),
            (this.onprocessorerror = Xi);
          const e = URL.createObjectURL(
              new Blob([Array.from(Kr).join("\n")], { type: "text/javascript" })
            ),
      ...
      class na extends sa {
        constructor() {
          super(Oi(na.getDefaults(), arguments, ["delayTime", "resonance"])),
            (this.name = "FeedbackCombFilter");
          const t = Oi(na.getDefaults(), arguments, ["delayTime", "resonance"]);
          (this.input = new Co({ context: this.context })),
            (this.output = new Co({ context: this.context })),
            (this.delayTime = new wo({
              context: this.context,
      ...
      class ia extends bo {
        constructor() {
          super(Oi(ia.getDefaults(), arguments, ["frequency", "type"])),
            (this.name = "OnePoleFilter");
          const t = Oi(ia.getDefaults(), arguments, ["frequency", "type"]);
      ...
      class oa extends bo {
        constructor() {
          ...
          const t = Oi(oa.getDefaults(), arguments, [
            "delayTime",
            "resonance",
            "dampening",
          ]);
          (this._combFilter = this.output = new na({
            context: this.context,
            ...
            (this._lowpass = this.input = new ia({
              context: this.context,
      ...
      class ra extends Nr {
        constructor() {
          super(Oi(ra.getDefaults(), arguments)), (this.name = "PluckSynth");
          const t = Oi(ra.getDefaults(), arguments);
          (this._noise = new Ko({ context: this.context, type: "pink" })),
      ...
      class aa extends Nr {
        constructor() {
          super(Oi(aa.getDefaults(), arguments, ["voice", "options"])),
            (this.name = "PolySynth"),
          ...
          const t = Oi(aa.getDefaults(), arguments, ["voice", "options"]);
          ei(
            !li(t.voice),
        ...
        _getNextAvailableVoice() {
          ...
          ai("Max polyphony exceeded. Note dropped.");
        }
        _collectGarbage() {
          if (
        ...
        _triggerAttack(t, e, s) {
          t.forEach((t) => {
            const n = new Po(this.context, t).toMidi(),
        ...
        _triggerRelease(t, e) {
          t.forEach((t) => {
            const s = new Po(this.context, t).toMidi(),
        ...
        _scheduleEvent(t, e, s, n) {
          ei(!this.disposed, "Synth was already disposed"),
            s <= this.now()
              ? "attack" === t
        ...
        triggerAttackRelease(t, e, s, n) {
          const i = this.toSeconds(s);
          if ((this.triggerAttack(t, i, n), fi(e))) {
            ei(
              fi(t),
            ...
            for (let s = 0; s < t.length; s++) {
              const n = e[Math.min(s, e.length - 1)],
                o = this.toSeconds(n);
              ei(o > 0, "The duration must be greater than 0"),
                this.triggerRelease(t[s], i + o);
            }
          } else {
            const s = this.toSeconds(e);
            ei(s > 0, "The duration must be greater than 0"),
        ...
        set(t) {
          const e = Ei(t, ["onsilence", "context"]);
          return (
            (this.options = Di(this.options, e)),
      ...
      class ca extends Nr {
        constructor() {
          ...
          Object.keys(t.urls).forEach((s) => {
            ...
            if (
              (ei(
                mi(s) || (li(n) && isFinite(n)),
                "url key is neither a note or midi pitch: " + s
              ),
              mi(s))
            ) {
              const n = new po(this.context, s).toMidi();
              e[n] = t.urls[s];
            } else li(n) && isFinite(n) && (e[n] = t.urls[n]);
          }),
            (this._buffers = new No({
              urls: e,
              onload: t.onload,
        ...
        triggerAttack(t, e, s = 1) {
          return (
            ...
            Array.isArray(t) || (t = [t]),
            t.forEach((t) => {
              const n = ao(new po(this.context, t).toFrequency()),
                i = Math.round(n),
                o = n - i,
        ...
        triggerAttackRelease(t, e, s, n = 1) {
          ...
          return (
            this.triggerAttack(t, i, n),
              ...
              ? (ei(fi(t), "notes must be an array when duration is array"),
                t.forEach((t, s) => {
                  const n = e[Math.min(s, e.length - 1)];
        ...
        add(t, e, s) {
          if (
            (ei(mi(t) || isFinite(t), "note must be a pitch or midi: " + t),
            mi(t))
          ) {
            const n = new po(this.context, t).toMidi();
      ...
      yi([br(0)], ca.prototype, "attack", void 0),
        yi([br(0)], ca.prototype, "release", void 0);
      class ha extends yo {
        constructor() {
          super(Oi(ha.getDefaults(), arguments, ["callback", "value"])),
            (this.name = "ToneEvent"),
            (this._state = new xo("stopped")),
            (this._startOffset = 0);
          const t = Oi(ha.getDefaults(), arguments, ["callback", "value"]);
          (this._loop = t.loop),
            (this.callback = t.callback),
            (this.value = t.value),
        ...
        _rescheduleEvents(t = -1) {
          this._state.forEachFrom(t, (t) => {
            ...
            if ("started" === t.state) {
              ...
              if (!0 === this._loop || (li(this._loop) && this._loop > 1)) {
                (e = 1 / 0),
                  li(this._loop) && (e = this._loop * this._getLoopDuration());
                const n = this._state.getAfter(s);
                null !== n && (e = Math.min(e, n.time - s)),
                  e !== 1 / 0 && (e = new Lo(this.context, e));
                const i = new Lo(this.context, this._getLoopDuration());
                t.id = this.context.transport.scheduleRepeat(
                  this._tick.bind(this),
                  i,
                  new Lo(this.context, s),
                  e
                );
              } else
        ...
        _tick(t) {
          ...
          if (!this.mute && "started" === this._state.getValueAtTime(e)) {
            ...
            if (this.humanize) {
              let e = 0.02;
              di(this.humanize) || (e = this.toSeconds(this.humanize)),
                (t += (2 * Math.random() - 1) * e);
            }
        ...
        get loopEnd() {
          return new Lo(this.context, this._loopEnd).toSeconds();
        }
        set loopEnd(t) {
          (this._loopEnd = this.toTicks(t)),
        ...
        get loopStart() {
          return new Lo(this.context, this._loopStart).toSeconds();
        }
        set loopStart(t) {
          (this._loopStart = this.toTicks(t)),
            this._loop && this._rescheduleEvents();
      ...
      class ua extends yo {
        constructor() {
          super(Oi(ua.getDefaults(), arguments, ["callback", "interval"])),
            (this.name = "Loop");
          const t = Oi(ua.getDefaults(), arguments, ["callback", "interval"]);
          (this._event = new ha({
            context: this.context,
            callback: this._tick.bind(this),
            loop: !0,
      ...
      class la extends ha {
        constructor() {
          super(Oi(la.getDefaults(), arguments, ["callback", "events"])),
            (this.name = "Part"),
            (this._state = new xo("stopped")),
            (this._events = new Set());
          const t = Oi(la.getDefaults(), arguments, ["callback", "events"]);
          (this._state.increasing = !0),
            t.events.forEach((t) => {
              fi(t) ? this.add(t[0], t[1]) : this.add(t);
            });
        }
        static getDefaults() {
          return Object.assign(ha.getDefaults(), { events: [] });
        }
        start(t, e) {
          const s = this.toTicks(t);
          if ("started" !== this._state.getValueAtTime(s)) {
            (e = Mi(e, this._loop ? this._loopStart : 0)),
              (e = this._loop ? Mi(e, this._loopStart) : Mi(e, 0));
            ...
            this._loop
              ? t.startOffset >= this._loopStart &&
                ...
                ? (t.startOffset < s && (e += this._getLoopDuration()),
                  t.start(new Lo(this.context, e)))
                : t.startOffset < this._loopStart &&
                  t.startOffset >= s &&
                  ((t.loop = !1), t.start(new Lo(this.context, e)))
              : t.startOffset >= s && t.start(new Lo(this.context, e));
        }
        get startOffset() {
          return this._startOffset;
        }
        ...
        at(t, e) {
          const s = new go(this.context, t).toTicks(),
            n = new Lo(this.context, 1).toSeconds(),
            i = this._events.values();
          let o = i.next();
          for (; !o.done; ) {
            const t = o.value;
            if (Math.abs(s - t.startOffset) < n)
              return hi(e) && (t.value = e), t;
            o = i.next();
          }
          return hi(e) ? (this.add(t, e), this.at(t)) : null;
        }
        add(t, e) {
        ...
        _restartEvent(t) {
          this._state.forEach((e) => {
            "started" === e.state
              ...
              : t.stop(new Lo(this.context, e.time));
          });
        }
        remove(t, e) {
          return (
            pi(t) && t.hasOwnProperty("time") && (t = (e = t).time),
            (t = this.toTicks(t)),
          ...
          return (
            this._events &&
              this._events.forEach((e) => {
                e instanceof la ? e._forEach(t) : t(e);
              }),
            this
          );
        }
      ...
      function* pa(t) {
        let e = 0;
        for (; e < t.length; ) (e = _a(e, t)), yield t[e], e++;
      }
      function* da(t) {
        let e = t.length - 1;
        for (; e >= 0; ) (e = _a(e, t)), yield t[e], e--;
      }
      function* fa(t, e) {
        for (;;) yield* e(t);
      }
      function _a(t, e) {
        return Ni(t, 0, e.length - 1);
      }
      function* ma(t, e) {
      ...
      function* ga(t) {
        let e = 0,
          s = 0;
        for (; e < t.length; )
          (e = _a(e, t)), yield t[e], s++, (e += s % 2 ? 2 : -1);
      }
      function* va(t) {
        let e = t.length - 1,
          s = 0;
        for (; e >= 0; ) (e = _a(e, t)), yield t[e], s++, (e += s % 2 ? -2 : 1);
      }
      function* ya(t) {
        const e = [];
        for (let s = 0; s < t.length; s++) e.push(s);
        for (; e.length > 0; ) {
          const s = _a(e.splice(Math.floor(e.length * Math.random()), 1)[0], t);
          yield t[s];
        }
      }
      function* xa(t, e = "up", s = 0) {
        switch (
          (ei(t.length > 0, "The array must have more than one value in it"), e)
        ) {
          case "up":
            yield* fa(t, pa);
          case "down":
      ...
      class wa extends ua {
        constructor() {
          super(
            Oi(wa.getDefaults(), arguments, ["callback", "values", "pattern"])
          ),
            (this.name = "Pattern");
          const t = Oi(wa.getDefaults(), arguments, [
            "callback",
            "values",
            "pattern",
          ]);
          (this.callback = t.callback),
            ...
            (this._pattern = xa(t.values, t.pattern)),
        ...
        set pattern(t) {
          (this._type = t), (this._pattern = xa(this._values, this._type));
        }
      }
      class ba extends ha {
        constructor() {
          super(
            Oi(ba.getDefaults(), arguments, [
              "callback",
              "events",
              "subdivision",
            ])
            ...
            (this._events = []),
            (this._eventsArray = []);
          const t = Oi(ba.getDefaults(), arguments, [
            "callback",
            "events",
            "subdivision",
          ]);
        ...
        static getDefaults() {
          return Object.assign(Ei(ha.getDefaults(), ["value"]), {
            events: [],
            loop: !0,
            loopEnd: 0,
            loopStart: 0,
        ...
        get subdivision() {
          return new Lo(this.context, this._subdivision).toSeconds();
        }
        _createSequence(t) {
          return new Proxy(t, {
            get: (t, e) => t[e],
            set: (t, e, s) => (
              _i(e) && isFinite(parseInt(e, 10)) && fi(s)
        ...
        _rescheduleSequence(t, e, s) {
          t.forEach((t, n) => {
            const i = n * e + s;
            if (fi(t)) this._rescheduleSequence(t, e / t.length, i);
            else {
              const e = new Lo(this.context, i, "i").toSeconds();
              this._part.add(e, t);
            }
          });
        }
      ...
      class Ta extends bo {
        constructor() {
          super(Object.assign(Oi(Ta.getDefaults(), arguments, ["fade"]))),
            (this.name = "CrossFade"),
            (this._panner = this.context.createStereoPanner()),
            (this._split = this.context.createChannelSplitter(2)),
            (this._g2a = new Ar({ context: this.context })),
            (this.a = new Co({ context: this.context, gain: 0 })),
            (this.b = new Co({ context: this.context, gain: 0 })),
            (this.output = new Co({ context: this.context })),
            (this._internalChannels = [this.a, this.b]);
          const t = Oi(Ta.getDefaults(), arguments, ["fade"]);
          (this.fade = new Oo({
            context: this.context,
            units: "normalRange",
            value: t.fade,
            ...
            So(this._split, this.a.gain, 0),
            So(this._split, this.b.gain, 1),
            this.fade.chain(this._g2a, this._panner.pan),
            this.a.connect(this.output),
            this.b.connect(this.output);
        }
        static getDefaults() {
          return Object.assign(bo.getDefaults(), { fade: 0.5 });
        }
        dispose() {
          return (
            super.dispose(),
      ...
      class Sa extends bo {
        constructor(t) {
          super(t),
            (this.name = "Effect"),
            (this._dryWet = new Ta({ context: this.context })),
            (this.wet = this._dryWet.fade),
            (this.effectSend = new Co({ context: this.context })),
            (this.effectReturn = new Co({ context: this.context })),
            (this.input = new Co({ context: this.context })),
        ...
        static getDefaults() {
          return Object.assign(bo.getDefaults(), { wet: 1 });
        }
        connectEffect(t) {
          return (
      ...
      class Ca extends ka {
        constructor() {
          ...
          const t = Oi(Ca.getDefaults(), arguments, [
            "frequency",
            "baseFrequency",
            "octaves",
          ]);
      ...
      class Aa extends bo {
        constructor() {
          super(Object.assign(Oi(Aa.getDefaults(), arguments, ["pan"]))),
            (this.name = "Panner"),
            (this._panner = this.context.createStereoPanner()),
            (this.input = this._panner),
            (this.output = this._panner);
          const t = Oi(Aa.getDefaults(), arguments, ["pan"]);
          (this.pan = new wo({
            context: this.context,
        ...
        static getDefaults() {
          return Object.assign(bo.getDefaults(), { pan: 0, channelCount: 1 });
        }
        dispose() {
          return (
      ...
      class Da extends ka {
        constructor() {
          super(Oi(Da.getDefaults(), arguments, ["frequency"])),
            (this.name = "AutoPanner");
          const t = Oi(Da.getDefaults(), arguments, ["frequency"]);
          (this._panner = new Aa({
            context: this.context,
        ...
        static getDefaults() {
          return Object.assign(ka.getDefaults(), { channelCount: 1 });
        }
        dispose() {
      ...
      class Oa extends bo {
        constructor() {
          super(Oi(Oa.getDefaults(), arguments, ["smoothing"])),
            (this.name = "Follower");
          const t = Oi(Oa.getDefaults(), arguments, ["smoothing"]);
          (this._abs = this.input = new Cr({ context: this.context })),
            (this._lowpass = this.output = new ia({
              context: this.context,
        ...
        static getDefaults() {
          return Object.assign(bo.getDefaults(), { smoothing: 0.05 });
        }
        get smoothing() {
      ...
      class Ma extends Sa {
        constructor() {
          super(
            ...
            (this.name = "AutoWah");
          const t = Oi(Ma.getDefaults(), arguments, [
            "baseFrequency",
            "octaves",
            "sensitivity",
          ]);
          (this._follower = new Oa({
            context: this.context,
            smoothing: t.follower,
          })),
            (this._sweepRange = new qr({
              context: this.context,
              min: 0,
              max: 1,
              exponent: 0.5,
            ...
            (this._baseFrequency = this.toFrequency(t.baseFrequency)),
            (this._octaves = t.octaves),
            (this._inputBoost = new Co({ context: this.context })),
            (this._bandpass = new Gr({
              context: this.context,
              rolloff: -48,
              frequency: 0,
              Q: t.Q,
            })),
            (this._peaking = new Gr({
              context: this.context,
              type: "peaking",
            })),
        ...
        get sensitivity() {
          return no(1 / this._inputBoost.gain.value);
        }
        set sensitivity(t) {
          this._inputBoost.gain.value = 1 / so(t);
        }
        _setSweepRange() {
      ...
      class Ea extends Sa {
        constructor() {
          super(Oi(Ea.getDefaults(), arguments, ["bits"])),
            (this.name = "BitCrusher");
          const t = Oi(Ea.getDefaults(), arguments, ["bits"]);
          (this._bitCrusherWorklet = new Ra({
            context: this.context,
            bits: t.bits,
          })),
        ...
        static getDefaults() {
          return Object.assign(Sa.getDefaults(), { bits: 4 });
        }
        dispose() {
      ...
      class Ra extends sa {
        constructor() {
          super(Oi(Ra.getDefaults(), arguments)),
        ...
        static getDefaults() {
          return Object.assign(sa.getDefaults(), { bits: 12 });
        }
        _audioWorkletName() {
          return "bit-crusher";
        }
      ...
      class qa extends Sa {
        constructor() {
          super(Oi(qa.getDefaults(), arguments, ["order"])),
            (this.name = "Chebyshev");
          const t = Oi(qa.getDefaults(), arguments, ["order"]);
          (this._shaper = new ar({ context: this.context, length: 4096 })),
            (this._order = t.order),
      ...
      class Fa extends bo {
        constructor() {
          super(Oi(Fa.getDefaults(), arguments, ["channels"])),
            (this.name = "Split");
          const t = Oi(Fa.getDefaults(), arguments, ["channels"]);
        ...
        static getDefaults() {
          return Object.assign(bo.getDefaults(), { channels: 2 });
        }
        dispose() {
      ...
      class Ia extends bo {
        constructor() {
          super(Oi(Ia.getDefaults(), arguments, ["channels"])),
            (this.name = "Merge");
          const t = Oi(Ia.getDefaults(), arguments, ["channels"]);
      ...
      class Va extends bo {
        constructor(t) {
          super(t),
            ...
            (this._dryWet = this.output = new Ta({
              context: this.context,
              fade: t.wet,
            })),
            (this.wet = this._dryWet.fade),
            (this._split = new Fa({ context: this.context, channels: 2 })),
            (this._merge = new Ia({ context: this.context, channels: 2 })),
        ...
        connectEffectLeft(...t) {
          this._split.connect(t[0], 0, 0),
            To(...t),
            So(t[t.length - 1], this._merge, 0, 0);
        }
        connectEffectRight(...t) {
          this._split.connect(t[0], 1, 0),
            To(...t),
            So(t[t.length - 1], this._merge, 0, 1);
        }
        static getDefaults() {
          return Object.assign(bo.getDefaults(), { wet: 1 });
        }
      ...
      class Na extends Va {
        constructor(t) {
          super(t),
            (this.feedback = new Oo({
              context: this.context,
              value: t.feedback,
              units: "normalRange",
            })),
            (this._feedbackL = new Co({ context: this.context })),
            (this._feedbackR = new Co({ context: this.context })),
            (this._feedbackSplit = new Fa({
              context: this.context,
              channels: 2,
            })),
            (this._feedbackMerge = new Ia({
              context: this.context,
              channels: 2,
            })),
        ...
        static getDefaults() {
          return Object.assign(Va.getDefaults(), { feedback: 0.5 });
        }
        dispose() {
          return (
            super.dispose(),
      ...
      class Pa extends Na {
        constructor() {
          super(
            Oi(Pa.getDefaults(), arguments, ["frequency", "delayTime", "depth"])
          ),
            (this.name = "Chorus");
          const t = Oi(Pa.getDefaults(), arguments, [
            "frequency",
            "delayTime",
            "depth",
          ]);
          (this._depth = t.depth),
            ...
            (this._delayNodeL = new Io({ context: this.context })),
            (this._delayNodeR = new Io({ context: this.context })),
      ...
      class ja extends Sa {
        constructor() {
          super(Oi(ja.getDefaults(), arguments, ["distortion"])),
            (this.name = "Distortion");
          const t = Oi(ja.getDefaults(), arguments, ["distortion"]);
          (this._shaper = new ar({ context: this.context, length: 4096 })),
      ...
      class La extends Sa {
        ...
        static getDefaults() {
          return Object.assign(Sa.getDefaults(), { feedback: 0.125 });
        }
        dispose() {
          return (
            super.dispose(),
      ...
      class za extends La {
        constructor() {
          super(Oi(za.getDefaults(), arguments, ["delayTime", "feedback"])),
            (this.name = "FeedbackDelay");
          const t = Oi(za.getDefaults(), arguments, ["delayTime", "feedback"]);
          (this._delayNode = new Io({
            context: this.context,
            delayTime: t.delayTime,
            maxDelay: t.maxDelay,
          })),
      ...
      class Ba extends bo {
        constructor(t) {
          super(t),
            ...
            (this.input = new Co({ context: this.context })),
            (this.output = new Co({ context: this.context })),
            (this.offset90 = new Co({ context: this.context }));
          (this._bank0 = this._createAllPassFilterBank([
            ...
            To(this.input, ...this._bank0, this._oneSampleDelay, this.output),
            To(this.input, ...this._bank1, this.offset90);
        }
      ...
      class Wa extends Sa {
        constructor() {
          super(Oi(Wa.getDefaults(), arguments, ["frequency"])),
            (this.name = "FrequencyShifter");
          const t = Oi(Wa.getDefaults(), arguments, ["frequency"]);
          (this.frequency = new Oo({
            context: this.context,
            units: "frequency",
            value: t.frequency,
            ...
            (this._sine = new ir({ context: this.context, type: "sine" })),
            (this._cosine = new or({
              context: this.context,
              phase: -90,
              type: "sine",
            })),
            (this._sineMultiply = new hr({ context: this.context })),
            (this._cosineMultiply = new hr({ context: this.context })),
            (this._negate = new Dr({ context: this.context })),
            (this._add = new gr({ context: this.context })),
            (this._phaseShifter = new Ba({ context: this.context })),
        ...
        static getDefaults() {
          return Object.assign(Sa.getDefaults(), { frequency: 0 });
        }
        dispose() {
          return (
            super.dispose(),
      ...
      class Qa extends Va {
        constructor() {
          super(Oi(Qa.getDefaults(), arguments, ["roomSize", "dampening"])),
            (this.name = "Freeverb"),
            (this._combFilters = []),
            (this._allpassFiltersL = []),
            (this._allpassFiltersR = []);
          const t = Oi(Qa.getDefaults(), arguments, ["roomSize", "dampening"]);
          (this.roomSize = new Oo({
            context: this.context,
            value: t.roomSize,
            units: "normalRange",
          })),
            (this._allpassFiltersL = Ua.map((t) => {
              const e = this.context.createBiquadFilter();
              return (e.type = "allpass"), (e.frequency.value = t), e;
            })),
            (this._allpassFiltersR = Ua.map((t) => {
              const e = this.context.createBiquadFilter();
              return (e.type = "allpass"), (e.frequency.value = t), e;
            })),
            (this._combFilters = Ga.map((e, s) => {
              const n = new oa({
                context: this.context,
                dampening: t.dampening,
                delayTime: e,
      ...
      const Za = [0.06748, 0.06404, 0.08212, 0.09004],
        Xa = [0.773, 0.802, 0.753, 0.733],
        Ya = [347, 113, 37];
      class Ha extends Va {
        constructor() {
          super(Oi(Ha.getDefaults(), arguments, ["roomSize"])),
            (this.name = "JCReverb"),
            (this._allpassFilters = []),
            (this._feedbackCombFilters = []);
          const t = Oi(Ha.getDefaults(), arguments, ["roomSize"]);
          (this.roomSize = new Oo({
            context: this.context,
            value: t.roomSize,
            units: "normalRange",
          })),
            (this._scaleRoomSize = new vr({
              context: this.context,
              min: -0.733,
              max: 0.197,
            })),
            (this._allpassFilters = Ya.map((t) => {
              const e = this.context.createBiquadFilter();
              return (e.type = "allpass"), (e.frequency.value = t), e;
            })),
            (this._feedbackCombFilters = Za.map((t, e) => {
              const s = new na({ context: this.context, delayTime: t });
              return (
                this._scaleRoomSize.connect(s.resonance),
                (s.resonance.value = Xa[e]),
                e < Za.length / 2
        ...
        static getDefaults() {
          return Object.assign(Va.getDefaults(), { roomSize: 0.5 });
        }
        dispose() {
          return (
            super.dispose(),
      ...
      class Ja extends $a {
        constructor() {
          super(Oi(Ja.getDefaults(), arguments, ["delayTime", "feedback"])),
            (this.name = "PingPongDelay");
          const t = Oi(Ja.getDefaults(), arguments, ["delayTime", "feedback"]);
          (this._leftDelay = new Io({
            context: this.context,
            maxDelay: t.maxDelay,
          })),
            (this._rightDelay = new Io({
              context: this.context,
              maxDelay: t.maxDelay,
            })),
            (this._rightPreDelay = new Io({
              context: this.context,
              maxDelay: t.maxDelay,
            })),
            (this.delayTime = new Oo({
              context: this.context,
              units: "time",
              value: t.delayTime,
            })),
      ...
      class Ka extends La {
        constructor() {
          super(Oi(Ka.getDefaults(), arguments, ["pitch"])),
            (this.name = "PitchShift");
          const t = Oi(Ka.getDefaults(), arguments, ["pitch"]);
          (this._frequency = new Oo({ context: this.context })),
            (this._delayA = new Io({ maxDelay: 1, context: this.context })),
            (this._lfoA = new xr({
              context: this.context,
              min: 0,
              max: 0.1,
            ...
            (this._delayB = new Io({ maxDelay: 1, context: this.context })),
            (this._lfoB = new xr({
              context: this.context,
              min: 0,
              max: 0.1,
            ...
            (this._crossFade = new Ta({ context: this.context })),
            (this._crossFadeLFO = new xr({
              context: this.context,
              min: 0,
              max: 1,
              type: "triangle",
      ...
      class tc extends Va {
        constructor() {
          super(
            ...
            (this.name = "Phaser");
          const t = Oi(tc.getDefaults(), arguments, [
            "frequency",
            "octaves",
            "baseFrequency",
          ]);
      ...
      class ec extends Sa {
        constructor() {
          super(Oi(ec.getDefaults(), arguments, ["decay"])),
            (this.name = "Reverb"),
            (this._convolver = this.context.createConvolver()),
            (this.ready = Promise.resolve());
          const t = Oi(ec.getDefaults(), arguments, ["decay"]);
          (this._decay = t.decay),
        ...
        set preDelay(t) {
          si((t = this.toSeconds(t)), 0), (this._preDelay = t), this.generate();
        }
        generate() {
          return xi(this, void 0, void 0, function* () {
            const t = this.ready,
            ...
            const o = new Co({ context: e }).toDestination();
            i.connect(o),
              s.start(0),
              n.start(0),
      ...
      class sc extends bo {
        constructor() {
          super(Oi(sc.getDefaults(), arguments)),
            (this.name = "MidSideSplit"),
            (this._split = this.input = new Fa({
              channels: 2,
              context: this.context,
            })),
            (this._midAdd = new gr({ context: this.context })),
            (this.mid = new hr({ context: this.context, value: Math.SQRT1_2 })),
            (this._sideSubtract = new Or({ context: this.context })),
            (this.side = new hr({
              context: this.context,
              value: Math.SQRT1_2,
            })),
      ...
      class nc extends bo {
        constructor() {
          super(Oi(nc.getDefaults(), arguments)),
            (this.name = "MidSideMerge"),
            (this.mid = new Co({ context: this.context })),
            (this.side = new Co({ context: this.context })),
            (this._left = new gr({ context: this.context })),
            (this._leftMult = new hr({
              context: this.context,
              value: Math.SQRT1_2,
            })),
            (this._right = new Or({ context: this.context })),
            (this._rightMult = new hr({
              context: this.context,
              value: Math.SQRT1_2,
            })),
            (this._merge = this.output = new Ia({ context: this.context })),
      ...
      class ic extends Sa {
        constructor(t) {
          super(t),
            ...
            (this._midSideMerge = new nc({ context: this.context })),
            (this._midSideSplit = new sc({ context: this.context })),
      ...
      class oc extends ic {
        constructor() {
          super(Oi(oc.getDefaults(), arguments, ["width"])),
            (this.name = "StereoWidener");
          const t = Oi(oc.getDefaults(), arguments, ["width"]);
          (this.width = new Oo({
            context: this.context,
            value: t.width,
            units: "normalRange",
            ...
            Qi(this, ["width"]),
            (this._twoTimesWidthMid = new hr({
              context: this.context,
              value: 2,
            })),
            (this._twoTimesWidthSide = new hr({
              context: this.context,
              value: 2,
            })),
            (this._midMult = new hr({ context: this.context })),
            this._twoTimesWidthMid.connect(this._midMult.factor),
            this.connectEffectMid(this._midMult),
            (this._oneMinusWidth = new Or({ context: this.context })),
            this._oneMinusWidth.connect(this._twoTimesWidthMid),
            So(this.context.getConstant(1), this._oneMinusWidth),
            this.width.connect(this._oneMinusWidth.subtrahend),
            (this._sideMult = new hr({ context: this.context })),
            this.width.connect(this._twoTimesWidthSide),
            this._twoTimesWidthSide.connect(this._sideMult.factor),
            this.connectEffectSide(this._sideMult);
        }
        static getDefaults() {
          return Object.assign(ic.getDefaults(), { width: 0.5 });
        }
        dispose() {
          return (
            super.dispose(),
      ...
      class rc extends Va {
        constructor() {
          super(Oi(rc.getDefaults(), arguments, ["frequency", "depth"])),
            (this.name = "Tremolo");
          const t = Oi(rc.getDefaults(), arguments, ["frequency", "depth"]);
          (this._lfoL = new xr({
            context: this.context,
            type: t.type,
            min: 1,
            ...
            (this._amplitudeL = new Co({ context: this.context })),
            (this._amplitudeR = new Co({ context: this.context })),
            (this.frequency = new Oo({
              context: this.context,
              value: t.frequency,
              units: "frequency",
      ...
      class ac extends Sa {
        constructor() {
          super(Oi(ac.getDefaults(), arguments, ["frequency", "depth"])),
            (this.name = "Vibrato");
          const t = Oi(ac.getDefaults(), arguments, ["frequency", "depth"]);
          (this._delayNode = new Io({
            context: this.context,
            delayTime: 0,
            maxDelay: t.maxDelay,
      ...
      class cc extends bo {
        constructor() {
          super(Oi(cc.getDefaults(), arguments, ["type", "size"])),
            (this.name = "Analyser"),
            (this._analysers = []),
            (this._buffers = []);
          const t = Oi(cc.getDefaults(), arguments, ["type", "size"]);
          (this.input = this.output = this._gain = new Co({
            context: this.context,
          })),
            (this._split = new Fa({
              context: this.context,
        ...
        set type(t) {
          ei("waveform" === t || "fft" === t, "Analyser: invalid type: " + t),
            (this._type = t);
        }
        get smoothing() {
      ...
      class hc extends bo {
        constructor() {
          super(Oi(hc.getDefaults(), arguments)),
            (this.name = "MeterBase"),
            (this.input = this.output = this._analyser = new cc({
              context: this.context,
              size: 256,
              type: "waveform",
            }));
      ...
      class uc extends hc {
        constructor() {
          super(Oi(uc.getDefaults(), arguments, ["smoothing"])),
            (this.name = "Meter"),
            (this._rms = 0);
          const t = Oi(uc.getDefaults(), arguments, ["smoothing"]);
          (this.input = this.output = this._analyser = new cc({
            context: this.context,
            size: 256,
            type: "waveform",
        ...
        getLevel() {
          return (
            ai("'getLevel' has been changed to 'getValue'"), this.getValue()
          );
        }
        getValue() {
          const t = this._analyser.getValue(),
            e = (1 === this.channels ? [t] : t).map((t) => {
              ...
              return (
                ...
                this.normalRange ? this._rms : no(this._rms)
              );
            });
      ...
      class lc extends hc {
        constructor() {
          super(Oi(lc.getDefaults(), arguments, ["size"])), (this.name = "FFT");
          const t = Oi(lc.getDefaults(), arguments, ["size"]);
          (this.normalRange = t.normalRange),
      ...
      class pc extends hc {
        constructor() {
          super(Oi(pc.getDefaults(), arguments)),
            (this.name = "DCMeter"),
      ...
      class dc extends hc {
        constructor() {
          super(Oi(dc.getDefaults(), arguments, ["size"])),
            (this.name = "Waveform");
          const t = Oi(dc.getDefaults(), arguments, ["size"]);
          (this._analyser.type = "waveform"), (this.size = t.size);
        }
        static getDefaults() {
          return Object.assign(hc.getDefaults(), { size: 1024 });
        }
        getValue() {
      ...
      class fc extends bo {
        constructor() {
          super(Oi(fc.getDefaults(), arguments, ["solo"])),
            (this.name = "Solo");
          const t = Oi(fc.getDefaults(), arguments, ["solo"]);
          (this.input = this.output = new Co({ context: this.context })),
            fc._allSolos.has(this.context) ||
              fc._allSolos.set(this.context, new Set()),
            fc._allSolos.get(this.context).add(this),
            (this.solo = t.solo);
        }
        static getDefaults() {
          return Object.assign(bo.getDefaults(), { solo: !1 });
        }
        get solo() {
        ...
        set solo(t) {
          t ? this._addSolo() : this._removeSolo(),
            fc._allSolos.get(this.context).forEach((t) => t._updateSolo());
        }
        get muted() {
          return 0 === this.input.gain.value;
        }
        _addSolo() {
          fc._soloed.has(this.context) ||
            fc._soloed.set(this.context, new Set()),
            fc._soloed.get(this.context).add(this);
        }
        _removeSolo() {
          fc._soloed.has(this.context) &&
            fc._soloed.get(this.context).delete(this);
        }
        _isSoloed() {
          return (
            fc._soloed.has(this.context) &&
            fc._soloed.get(this.context).has(this)
          );
        }
        _noSolos() {
          return (
            !fc._soloed.has(this.context) ||
            (fc._soloed.has(this.context) &&
              0 === fc._soloed.get(this.context).size)
          );
        }
        _updateSolo() {
        ...
        dispose() {
          return (
            super.dispose(),
            fc._allSolos.get(this.context).delete(this),
            this._removeSolo(),
            this
          );
        }
      }
      (fc._allSolos = new Map()), (fc._soloed = new Map());
      class _c extends bo {
        constructor() {
          super(Oi(_c.getDefaults(), arguments, ["pan", "volume"])),
            (this.name = "PanVol");
          const t = Oi(_c.getDefaults(), arguments, ["pan", "volume"]);
          (this._panner = this.input = new Aa({
            context: this.context,
            pan: t.pan,
            channelCount: t.channelCount,
          })),
      ...
      class mc extends bo {
        constructor() {
          super(Oi(mc.getDefaults(), arguments, ["volume", "pan"])),
            (this.name = "Channel");
          const t = Oi(mc.getDefaults(), arguments, ["volume", "pan"]);
          (this._solo = this.input = new fc({
            solo: t.solo,
            context: this.context,
          })),
            (this._panVol = this.output = new _c({
              context: this.context,
              pan: t.pan,
              volume: t.volume,
              mute: t.mute,
        ...
        _getBus(t) {
          return (
            mc.buses.has(t) ||
              mc.buses.set(t, new Co({ context: this.context })),
            mc.buses.get(t)
          );
        }
        send(t, e = 0) {
          const s = this._getBus(t),
            n = new Co({ context: this.context, units: "decibels", gain: e });
      ...
      class gc extends bo {
        constructor() {
          super(Oi(gc.getDefaults(), arguments)),
            (this.name = "Mono"),
            (this.input = new Co({ context: this.context })),
            (this._merge = this.output = new Ia({
              channels: 2,
              context: this.context,
            })),
      ...
      class vc extends bo {
        constructor() {
          super(
            Oi(vc.getDefaults(), arguments, ["lowFrequency", "highFrequency"])
          ),
          ...
          const t = Oi(vc.getDefaults(), arguments, [
            "lowFrequency",
            "highFrequency",
          ]);
          (this.lowFrequency = new Oo({
            context: this.context,
            units: "frequency",
            value: t.lowFrequency,
          })),
            (this.highFrequency = new Oo({
              context: this.context,
              units: "frequency",
        ...
        dispose() {
          return (
            super.dispose(),
            Zi(this, ["high", "mid", "low", "highFrequency", "lowFrequency"]),
            this.low.dispose(),
      ...
      class yc extends bo {
        constructor() {
          super(...arguments),
            (this.name = "Listener"),
            (this.positionX = new wo({
              context: this.context,
              param: this.context.rawContext.listener.positionX,
            })),
            (this.positionY = new wo({
              context: this.context,
              param: this.context.rawContext.listener.positionY,
            })),
            (this.positionZ = new wo({
              context: this.context,
              param: this.context.rawContext.listener.positionZ,
            })),
            (this.forwardX = new wo({
              context: this.context,
              param: this.context.rawContext.listener.forwardX,
            })),
            (this.forwardY = new wo({
              context: this.context,
              param: this.context.rawContext.listener.forwardY,
            })),
            (this.forwardZ = new wo({
              context: this.context,
      ...
      class xc extends bo {
        constructor() {
          super(
            ...
            (this.name = "Panner3D");
          const t = Oi(xc.getDefaults(), arguments, [
            "positionX",
            "positionY",
            "positionZ",
          ]);
          (this._panner = this.input = this.output = this.context.createPanner()),
            ...
            (this.orientationX = new wo({
              context: this.context,
              param: this._panner.orientationX,
              value: t.orientationX,
            })),
            (this.orientationY = new wo({
              context: this.context,
              param: this._panner.orientationY,
              value: t.orientationY,
            })),
            (this.orientationZ = new wo({
              context: this.context,
      ...
      class wc extends bo {
        constructor() {
          super(Oi(wc.getDefaults(), arguments)), (this.name = "Recorder");
          const t = Oi(wc.getDefaults(), arguments);
          (this.input = new Co({ context: this.context })),
            ei(wc.supported, "Media Recorder API is not available"),
        ...
        static getDefaults() {
          return bo.getDefaults();
        }
        get mimeType() {
          return this._recorder.mimeType;
        }
        static get supported() {
          return null !== gi && Reflect.has(gi, "MediaRecorder");
        }
        get state() {
        ...
        start() {
          return xi(this, void 0, void 0, function* () {
            ei("started" !== this.state, "Recorder is already started");
        ...
        stop() {
          return xi(this, void 0, void 0, function* () {
            ei("stopped" !== this.state, "Recorder is not started");
            const t = new Promise((t) => {
              const e = (s) => {
        ...
        pause() {
          return (
            ei("started" === this.state, "Recorder must be started"),
      ...
      class bc extends bo {
        constructor() {
          super(Oi(bc.getDefaults(), arguments, ["threshold", "ratio"])),
            (this.name = "Compressor"),
            (this._compressor = this.context.createDynamicsCompressor()),
            (this.input = this._compressor),
            (this.output = this._compressor);
          const t = Oi(bc.getDefaults(), arguments, ["threshold", "ratio"]);
          (this.threshold = new wo({
            ...
            Qi(this, ["knee", "release", "attack", "ratio", "threshold"]);
        }
        static getDefaults() {
          return Object.assign(bo.getDefaults(), {
            attack: 0.003,
      ...
      class Tc extends bo {
        constructor() {
          super(
            Object.assign(
              Oi(Tc.getDefaults(), arguments, ["threshold", "smoothing"])
            )
          ),
            (this.name = "Gate");
          const t = Oi(Tc.getDefaults(), arguments, ["threshold", "smoothing"]);
          (this._follower = new Oa({
            context: this.context,
            ...
            (this._gt = new Er({
              context: this.context,
              value: so(t.threshold),
            })),
            (this.input = new Co({ context: this.context })),
            (this._gate = this.output = new Co({ context: this.context })),
      ...
      class Sc extends bo {
        constructor() {
          super(Object.assign(Oi(Sc.getDefaults(), arguments, ["threshold"]))),
            (this.name = "Limiter");
          const t = Oi(Sc.getDefaults(), arguments, ["threshold"]);
          (this._compressor = this.input = this.output = new bc({
            context: this.context,
            ratio: 20,
            attack: 0.003,
            release: 0.01,
        ...
        static getDefaults() {
          return Object.assign(bo.getDefaults(), { threshold: -12 });
        }
        get reduction() {
          return this._compressor.reduction;
        }
      ...
      class kc extends bo {
        constructor() {
          super(Object.assign(Oi(kc.getDefaults(), arguments))),
            (this.name = "MidSideCompressor");
          const t = Oi(kc.getDefaults(), arguments);
          (this._midSideSplit = this.input = new sc({ context: this.context })),
            (this._midSideMerge = this.output = new nc({
              context: this.context,
            })),
            (this.mid = new bc(
      ...
      class Cc extends bo {
        constructor() {
          super(Object.assign(Oi(Cc.getDefaults(), arguments))),
            (this.name = "MultibandCompressor");
          const t = Oi(Cc.getDefaults(), arguments);
          (this._splitter = this.input = new vc({
            context: this.context,
      ...
      class Ac extends bo {
        constructor() {
          super(Oi(Ac.getDefaults(), arguments, ["low", "mid", "high"])),
            (this.name = "EQ3"),
            (this.output = new Co({ context: this.context })),
            (this._internalChannels = []);
          const t = Oi(Ac.getDefaults(), arguments, ["low", "mid", "high"]);
          (this.input = this._multibandSplit = new vc({
            context: this.context,
            highFrequency: t.highFrequency,
            lowFrequency: t.lowFrequency,
          })),
            (this._lowGain = new Co({
              context: this.context,
              gain: t.low,
              units: "decibels",
            })),
            (this._midGain = new Co({
              context: this.context,
              gain: t.mid,
              units: "decibels",
            })),
            (this._highGain = new Co({
              context: this.context,
              gain: t.high,
              units: "decibels",
            })),
        ...
        dispose() {
          return (
            super.dispose(),
            Zi(this, ["low", "mid", "high", "lowFrequency", "highFrequency"]),
      ...
      class Dc extends bo {
        constructor() {
          super(Oi(Dc.getDefaults(), arguments, ["url", "onload"])),
            (this.name = "Convolver"),
            (this._convolver = this.context.createConvolver());
          const t = Oi(Dc.getDefaults(), arguments, ["url", "onload"]);
          (this._buffer = new Yi(t.url, (e) => {
        ...
        static getDefaults() {
          return Object.assign(bo.getDefaults(), { normalize: !0, onload: Xi });
        }
        load(t) {
          return xi(this, void 0, void 0, function* () {
      ...
      const Ec = Ki().transport;
      function Rc() {
        return Ki().transport;
      }
      const qc = Ki().destination,
        Fc = Ki().destination;
      function Ic() {
        return Ki().destination;
      }
      const Vc = Ki().listener;
      function Nc() {
        return Ki().listener;
      }
      const Pc = Ki().draw;
